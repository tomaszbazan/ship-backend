...
class BoardCreator {
    ...
    private static List<Field> createFourthLine() {
        ...
        fields.add(createField(3, line, 940, treasure(37)));
        ...
        fields.add(createField(8, line, 910, treasure(38)));
    ...
    private static List<Field> createFifthLine() {
        ...
        fields.add(createField(5, line, 1020, treasure(39)));
    ...
    private static List<Field> createSixthLine() {
        List<Field> fields = new ArrayList<>();
        int line = 6;
        fields.add(createField(1, line, 1050, treasure(40)));
        fields.add(createField(2, line, 1060, null));
        fields.add(createField(3, line, 1050, bottle(22)));
        fields.add(createField(4, line, 1080, treasure(41)));
        ...
        fields.add(createField(8, line, 1080, treasure(42)));
